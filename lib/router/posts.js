...
Meteor.startup(function () {
  ...
  Router.route('/category/:category/top/:limit?', {
    name: 'posts_top',
  ...
  Router.route('/category/:category/new/:limit?', {
    name: 'posts_new',
  ...
  Router.route('/category/:category/best/:limit?', {
    name: 'posts_best',
  ...
  Router.route('/category/:category/pending/:limit?', {
    name: 'posts_pending',
  ...
  Router.route('/category/:category/digest/:year/:month/:day', {
    name: 'posts_digest',
    controller: PostsDigestController
  });

  Router.route('/category/:category/digest', {
